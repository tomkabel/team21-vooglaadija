...
def upgrade() -> None:
    ...
    op.add_column('download_jobs', sa.Column('retry_count', sa.Integer(), nullable=False))
    op.add_column('download_jobs', sa.Column('max_retries', sa.Integer(), nullable=False))
    ...
    op.create_foreign_key(None, 'download_jobs', 'users', ['user_id'], ['id'], ondelete='CASCADE')
