        ...
        try:
            ...
            if is_format_error or job.retry_count >= job.max_retries:
                ...
                try:
                    ...
                    logger.error("job_failed_to_enqueue_for_retry", job_id=str(job_id), error=str(enqueue_error))
    ...
    async with session_factory() as db:
        ...
        for entry in entries:
            try:
                ...
                logger.error("failed_to_enqueue_job_from_outbox", job_id=str(entry.job_id), error=str(e))
