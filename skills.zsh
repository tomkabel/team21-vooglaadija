...
npx skills add vamseeachanta_workspace-hub@github-project-board -g -y
npx skills add anton-abyzov_specweave@github-issue-tracker -g -y
npx skills add n8n-io_n8n@linear-issue -g -y
npx skills list
